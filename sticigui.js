...
function Stici_HistHiLite(container_id, params) {
  ...
  this.reloadChart = function() {
    ...
    var width = self.chartDiv.width();
    var height = self.chartDiv.height();
    ...
    appendSvg(normalChartDiv).attr('fill', 'steelblue');
    appendSvg(self.overlayDiv).attr('fill', 'lemonchiffon');
