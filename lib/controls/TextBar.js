...
function SticiTextBar(params) {
  ...
  self.min = function(min) {
    if (min !== undefined) {
      ...
      slider.slider('option', 'min', self.options.min);
      self.val(self.val());
      return self;
    }
  ...
  self.max = function(max) {
    if (max !== undefined) {
      ...
      slider.slider('option', 'max', self.options.max);
      self.val(self.val());
      return self;
    }
  ...
  self.step = function(step) {
    if (step !== undefined) {
      ...
      slider.slider('option', 'step', self.options.step);
      self.val(self.val());
      return self;
    }
  ...
  function onChange(e, ui) {
    ...
    self.val(value);
    self.options.change(e, self.val());
  }
