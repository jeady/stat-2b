...
function Stici_HistHiLite(container_id, params) {
  ...
  function refreshFromExternalData() {
    ...
    self.additionalInfoDiv.html(info);
  }
  ...
  function loadBinomialData() {
    ...
    self.mu = n * p;
    self.reloadChart();
    self.additionalInfoDiv.html('n=' + n + '&nbsp;&nbsp;&nbsp;p=' + p);
  }
  ...
  function initControls() {
    ...
    function createSelectDataSourceControls() {
      ...
      dataSelectControls.append('Data: ').append(self.dataSelect);
    ...
    function createRestrictionControls() {
      ...
      clearAll.click(function() {
        self.restrictedUpperEnable.prop('checked', false);
        self.restrictUpper.val(self.binEnds.max());
        self.restrictedLowerEnable.prop('checked', false);
    ...
    self.additionalInfoDiv = jQuery('<div/>').addClass('additional_info');
    appendFooterRow(self.additionalInfoDiv);
