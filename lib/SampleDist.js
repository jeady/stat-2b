...
function refreshStatsBox() {
  ...
  var list = jQuery('<ul/>');
  list.append(jQuery('<li>' + popMeanText + '</li>'));
  list.append(jQuery('<li>' + popSdText + '</li>'));
  list.append(jQuery('<li>' + statExpText + '</li>'));
  list.append(jQuery('<li>' + statSEText + '</li>'));
  list.append(jQuery('<li>' + statSampleMeanText + '</li>'));
  list.append(jQuery('<li>' + statSampleSDText + '</li>'));
  list.append(jQuery('<li>' + samplesSoFarText + '</li>'));
...
function redrawChart() {
    ...
    function initControls() {
      ...
      // top_controls -> stici_chart -> area_info -> botom_contro`ls.
