    ...
    function initControls() {
      ...
      function createPopulationButton() {
        ...
        if (self.options.showPopulation)
          self.showBoxHist.text('Hide Population Histogram');
        else
          self.showBoxHist.text('Show Population Histogram');
        self.showBoxHist.click(function(e) {
          ...
          if (self.options.statisticType != CHISQUARE) {
            ...
            if (!self.options.showPopulation)
              self.showBoxHist
                  .text(self.showBoxHist.text().replace('Show', 'Hide'));
            else
              self.showBoxHist
                  .text(self.showBoxHist.text().replace('Hide', 'Show'));
