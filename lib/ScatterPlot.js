...
//  - files: Array of URLs (as strings) of json-encoded datasets
//  - graphAveButton: Whether or not to show the 'Graph of Ave' button.
//  - graphOfAvePoints: Number of points in Graph of Ave.
//  - addPoints: Boolean, true if user is allowed to add points to the chart.
//  - regressButton: Whether or not to show the 'Regression Line' button.
//  - residualsButton: Whether or not to show the 'Plot Residuals' button.
//  - sdButton: Whether or not to show the 'SDs' button.
//  - sdLineButton: Whether or not to show the 'SD Line' button.
//  - showR: Whether or not to show the 'R=' info.
//  - showSDs: Whether or not to show the SD Lines by default.
//  - showSdLine: Whether or not to show the SD Line by default.
//  - showGraphOfAve: Whether or not to show the Graph of Ave by default.
//  - showRegress: Whether or not to show the Regression Line by default.
//  - showResiduals: Whether or not to show the residuals by default.
//  - Xinit: Variable name to display on the X-axis by default.
//  - Yinit: Variable name to display on the Y-axis by default.
function Stici_Scatterplot(container_id, params) {
  ...
  this.reloadData = function() {
    ...
    self.dataFields = [];
    self.dataValues = [];
    self.dataSource = self.container.find('select.data_select').val();
