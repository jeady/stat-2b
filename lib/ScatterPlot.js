...
function Stici_Scatterplot(container_id, params) {
  ...
  function initControls() {
    ...
    var $bottom = $('<div/>').addClass('bottom_controls').addClass('extended'),
        ...
        $cursorPos  = $('<span/>').data('btnId', 'cursor-pos').text('');
  ...
  // document ready
  $().ready(function() {
    self.container.find('button').live('click', function(e) {
      handleBtnToggle(e);
    });
    self.container.find('.popbox').live('mouseover mouseout click', function(e) {
