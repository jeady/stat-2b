...
function Stici_Venn3(container_id, params) {
  ...
  var button_args = [
    ...
    [{label: 'B<sup>c</sup>', filled: s_outline, opaque: b_fill},
     {label: 'C<sup>c</sup>', filled: s_outline, opaque: c_fill},
    ...
    [{label: 'A<sup>c</sup>BC', filled: bc_fill, opaque: abc_fill},
     {label: 'A<sup>c</sup> or BC', filled: [bc_fill, s_outline], opaque: a_fill},
  ...
  $.each(button_args, function(i, button_row) {
    ...
    $.each(button_row, function(i, button) {
      ...
      button_div.click(function() {
        ...
        c_outline.removeClass('selected opaque');
        a_fill.removeClass('selected opaque');
        b_fill.removeClass('selected opaque');
        c_fill.removeClass('selected opaque');
        ab_fill.removeClass('selected opaque');
        bc_fill.removeClass('selected opaque');
        ac_fill.removeClass('selected opaque');
        //abc_fill.removeClass('selected opaque');
  ...
  function syncPositions() {
    ...
    var cx_offset = c_outline.offset().left + c_outline.width() -
      (s_outline.offset().left + s_outline.width());
    if (cx_offset > 0)
      c_outline.css('left', (c_outline.position().left - cx_offset) + 'px');
    var cy_offset = c_outline.offset().top + c_outline.height() -
      (s_outline.offset().top + s_outline.height());
    if (cy_offset > 0)
      c_outline.css('top', (c_outline.position().top - cy_offset) + 'px');
    ...
    if (c_outline.position().left < s_outline.position().left)
      c_outline.css('left', s_outline.position().left + 'px');
    if (c_outline.position().top < s_outline.position().top)
      c_outline.css('top', s_outline.position().top + 'px');
  ...
  function draw() {
    ...
    c_outline.css('left', (rectX + 16) + 'px');
    c_outline.css('top', (rectY - 32) + 'px');
