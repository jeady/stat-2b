...
function Stici_Venn3(container_id, params) {
  ...
  var a_fill, b_fill, c_fill, ab_fill, ac_fill, bc_fill;
  ...
  function syncPositions() {
    ...
    // Calculate the intersection. -- NEED TO ADD C
  ...
  function draw() {
    ...
    c_outline.css('left', (rectX + 32) + 'px');
    c_outline.css('top', (rectY + 16) + 'px');
